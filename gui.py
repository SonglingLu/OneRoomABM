...
# print('list_directory', os.listdir())
# os.path.expanduser('~bmman')
...
class user_viz(tk.Frame):
    ...
    def __init__(self, parent=None):
        ...
        self.model_label.grid(row=1, column=1)
        ...
        self.model_type.grid(row=2, column=1)

        # TODO: implement viz of bus routes
        ...
        self.students_label.grid(row=3, column=1)
        ...
        self.num_students.grid(row=4, column=1)

        # mask_percent
        self.mask_wearing_label = tk.Label(self, text="Percent of students wearing masks:")
        self.mask_wearing_label.grid(row=5, column=1)
        ...
        self.mask_wearing_choice.grid(row=6, column=1)

        # selfs
        self.Frame_label = tk.Label(self, text="Windows Open (inches):")
        self.Frame_label.grid(row=7, column=1)
        ...
        self.Frame_choice.grid(row=8, column=1)
        ...
        self.seating_plan.grid(row=6, column=2)

        # button widget for visualizing relative  airflow
        self.conc_avg_heat = tk.Button(self, text="Relative Airflow", command=self.conc_heat)
        self.conc_avg_heat.grid(row=7, column=2)

        # TODO: keep track in figure somehow
        # button widget keeping track of previous model runs
    ...
    def openT_P(self):
        ...
        # TODO: Replace these inputs with airavata defaults
